...
public class CustomersDAO {
	...
	public ArrayList<Customer> searchAllCustomer() throws Exception {
		...
		// make a query
		String selectQuery = "select customerId, userName, userPwd, firstName, lastName, address, city, postalcode,mobile from customers order by customerId asc";
		...
		try {
			...
			try {
				...
				while (rs.next()) {
					...
					customer.setMob(rs.getString(9));
