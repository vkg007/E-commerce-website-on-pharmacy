...
<title>Payment Redirect to Paytm gateway</title>
</head>
<body>
<%!
public class PaytmConstants {

	public final static String MID="HnyBOp69479919124696";
	public final static String MERCHANT_KEY="IgGaY18znNf%zx9@";
...
parameters.put("CALLBACK_URL", "http://localhost:8080/Online_medicine_version3.0/pgResponse.jsp");
